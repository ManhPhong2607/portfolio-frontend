...
// import { Badge } from '@/components/ui/badge'
// import { toast } from 'sonner'
// import type { BlogPostDetailDto } from '@/types/api'
...
//     content:      post?.content      ?? '',
//     excerpt:      post?.excerpt      ?? '',
//     coverMediaId: post?.id           ? undefined as string | undefined : undefined,
//     tagIds:       post?.tags.map(t => t.id) ?? [] as string[],
//   })

//   // Sync khi post load xong (edit mode)
//   useEffect(() => {
//     if (post) {
//       setForm({
//         title:        post.title,
...
//       if (mode === 'create') {
//         return adminService.createPost(payload)
//       } else {
//         return adminService.updatePost(post!.id, payload)
//       }
//     },
//     onSuccess: (data) => {
//       invalidate()
//       toast.success(mode === 'create' ? 'Đã tạo bài viết.' : 'Đã lưu.')
...
//           <Button variant="ghost" size="icon" asChild>
//             <Link href="/admin/blogs"><ArrowLeft size={18} /></Link>
//           </Button>
//           <div>
...
//             </h1>
//             {post && (
//               <Badge variant={post.status === 'Published' ? 'default' : 'secondary'} className="mt-1">
//                 {post.status}
//               </Badge>
//             )}
//           </div>
...
//           />
//           <p className="text-xs text-muted-foreground">
//             HTML content. TipTap editor sẽ được tích hợp sau.
//           </p>
//         </div>
